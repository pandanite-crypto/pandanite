...
SHA256Hash mineHash(SHA256Hash target, unsigned char challengeSize, bool usePufferfish=true);
bool verifyHash(SHA256Hash& target, SHA256Hash& nonce, unsigned char challengeSize, bool usePufferfish=true);
